...
import { FadeSection } from "@/app/components/FadeSection";
...
const jsonLd = {
  ...
  priceRange: "$$",
  image: "https://surfwithtee.com/images/tee-instructor.jpg",
};
    ...
    <main className="bg-[#FAFAF5] text-[#1C2B2B] overflow-x-hidden">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        <Image
          ...
          alt="Aerial view of Balangan Beach surf break, Uluwatu, Bali"
          fill
          priority
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-3xl mx-auto">
          <p className="text-xs uppercase tracking-[0.3em] mb-5 opacity-80 font-medium">Uluwatu, Bali · Indonesia</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="#contact" className="px-8 py-3.5 border border-white/70 text-white rounded-full font-medium text-sm tracking-wide hover:bg-white/10 transition-colors">Book a Session</a>
          </div>
        </div>
      ...
      <section id="about" className="py-24 md:py-36 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <FadeSection>
            ...
            <a href="#contact" className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#0A7075] text-white rounded-full font-medium text-sm tracking-wide hover:bg-[#065052] transition-colors">
              Surf With Tee
      ...
      <div className="relative h-[50vh] overflow-hidden">
        <Image src="/images/lesson-briefing-1.jpg" alt="Group surf lesson briefing on the beach at Balangan, Uluwatu" fill className="object-cover object-[center_40%]" sizes="100vw" />
        <div className="absolute inset-0 bg-[#1C2B2B]/50 flex flex-col items-center justify-center gap-4 px-6 text-center">
          <p className="font-display text-4xl md:text-6xl text-white font-light italic">&ldquo;Improve your skills with us.&rdquo;</p>
      ...
      <section id="lessons" className="py-24 md:py-36 px-6 max-w-7xl mx-auto">
        <FadeSection className="text-center mb-16">
          ...
          <p className="mt-4 text-[#2E4444] max-w-md mx-auto">Tailored to your level. All equipment provided. All sessions at the best breaks Bali has to offer.</p>
        </FadeSection>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-4">
          {([
            ...
            <FadeSection key={lesson.title} className={`rounded-2xl overflow-hidden flex flex-col ${lesson.highlight ? "ring-2 ring-[#0A7075] shadow-xl" : "shadow-md"}`} style={{ transitionDelay: `${i * 0.1}s` }}>
              {lesson.highlight && <div className="text-white text-center py-2 text-xs tracking-widest uppercase font-medium" style={{ background: "#F5821F" }}>Most Popular</div>}
              <div className="relative h-52 gallery-item">
                <Image src={lesson.image} alt={lesson.alt} fill className={`object-cover ${lesson.imgPos}`} sizes="(max-width: 768px) 100vw, 33vw" />
              </div>
              <div className="bg-white flex-1 p-7 flex flex-col">
                <div className="mb-4">
                  ...
                  <p className="font-display text-xl font-bold text-[#1C2B2B] mt-2">{lesson.price}</p>
                </div>
                <ul className="space-y-2.5 flex-1 mb-5">
                  {lesson.features.map((f) => (
                    <li key={f} className="flex items-start gap-2.5 text-sm text-[#2E4444]">
                      <svg className="w-4 h-4 mt-0.5 text-[#0A7075] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 13l4 4L19 7" /></svg>
                      {f}
                    </li>
                  ))}
                </ul>
                ...
                <a href="#contact" className={`w-full py-3 rounded-full text-sm font-medium text-center tracking-widest uppercase transition-colors ${lesson.highlight ? "bg-[#0A7075] text-white hover:bg-[#065052]" : "border border-[#0A7075] text-[#0A7075] hover:bg-[#E0F4F4]"}`}>Book Now</a>
              </div>
            </FadeSection>
          ))}
        </div>
        ...
        <FadeSection className="mb-16">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 py-5 bg-white rounded-2xl shadow-sm border border-[#E0E0D8]">
            ...
            <div className="flex items-center gap-6 sm:shrink-0">
              ...
              <a href="#contact" className="px-5 py-2 rounded-full text-xs font-medium tracking-widest uppercase border border-[#0A7075] text-[#0A7075] hover:bg-[#E0F4F4] transition-colors whitespace-nowrap">Book Now</a>
            </div>
          </div>
        </FadeSection>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {([
            { title: "3-Day Private", persons: "1 Person", price: "IDR 1.900.000", pricePhoto: "+ IDR 300.000", features: ["Expert coaching tailored to your skill level","Beginner to advanced — all levels welcome","Video review to track your progress"] },
            { title: "3-Day Semi-Private", persons: "2 Persons", price: "IDR 2.800.000", pricePhoto: "+ IDR 300.000", features: ["Perfect for friends or couples","Expert coaches tailor lessons for two","Video analysis included"] },
            { title: "3-Day Group", persons: "3 Persons", price: "IDR 3.400.000", pricePhoto: "+ IDR 300.000", features: ["Group energy — beginners to advanced welcome","Learn from each other with expert guidance","Video reviews to track group progress"] },
          ] as { title: string; persons: string; price: string; pricePhoto: string; features: string[] }[]).map((pkg, i) => (
            <FadeSection key={pkg.title} className="rounded-2xl overflow-hidden flex flex-col shadow-md" style={{ transitionDelay: `${i * 0.1}s` }}>
              ...
              <div className="bg-white flex-1 p-7 flex flex-col">
                ...
                <a href="#contact" className="w-full py-3 rounded-full text-sm font-medium text-center tracking-widest uppercase border border-[#0A7075] text-[#0A7075] hover:bg-[#E0F4F4] transition-colors">Book Now</a>
              </div>
            </FadeSection>
          ))}
        </div>
      ...
      <section id="gallery" className="py-24 md:py-36 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          {[
            ...
            { src: "/images/surf-action-5.jpg", pos: "object-center", tall: false, alt: "Group surf lesson in the water at Balangan, Bali" },
            { src: "/images/surf-action-6.jpg", pos: "object-center", tall: false, alt: "Aerial view of a surfer on a wave at Uluwatu, Bali" },
          ].map((img, i) => (
            <div key={i} className={`gallery-item rounded-xl overflow-hidden relative aspect-[4/3] md:aspect-auto ${img.tall ? "md:row-span-2 md:min-h-[420px]" : "md:min-h-[200px]"}`}>
              <Image src={img.src} alt={img.alt} fill className={`object-cover ${img.pos}`} sizes="(max-width: 768px) 50vw, 33vw" />
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeSection className="text-center mb-14">
            ...
            <p className="mt-4 text-[#2E4444] max-w-2xl mx-auto text-sm leading-relaxed">
              It&apos;s normal to feel &ldquo;in between&rdquo; levels — every surfer progresses at their own pace. These levels help us tailor coaching to your needs and guide the technical improvements we&apos;ll focus on during your stay. With video analysis from both water and air perspectives, you&apos;ll have every angle covered.
            </p>
          </FadeSection>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { level: "I", color: "#00AEEF", title: "Beginner", badge: "Start here" as string | null, points: ["Surf equipment & safety","How to paddle","Pop-up technique","Rules of the line-up"] },
              { level: "II", color: "#F5821F", title: "Getting Comfortable", badge: null, points: ["Comfortable in the line-up","Turtle rolls through whitewater","Standing on whitewater waves","Balancing your body weight"] },
              { level: "III", color: "#00A650", title: "Catching Unbroken Waves", badge: null, points: ["Positioning to catch waves solo","Using head weight while paddling","Right timing to paddle for a wave","Dropping down the face without falling"] },
              { level: "IV", color: "#EC008C", title: "Reading Waves", badge: "Advanced" as string | null, points: ["Wave reading basics","Anticipating wave direction","Angling the take-off","Trimming vs carving"] },
            ].map((l, i) => (
              <FadeSection key={l.level} className="bg-white rounded-2xl p-6 shadow-sm" style={{ transitionDelay: `${i * 0.1}s` }}>
                <div className="flex items-center justify-between mb-4">
                  <span className="font-display text-3xl font-semibold" style={{ color: l.color }}>{l.level}</span>
                  {l.badge && <span className="text-xs px-2.5 py-1 rounded-full font-medium" style={{ color: l.color, background: `${l.color}18` }}>{l.badge}</span>}
                </div>
                ...
                <ul className="space-y-2">
                  {l.points.map((p) => (
                    <li key={p} className="flex items-start gap-2 text-xs text-[#2E4444] leading-relaxed">
                      <span className="text-[#0A7075] mt-0.5 shrink-0">›</span>{p}
                    </li>
                  ))}
                </ul>
              </FadeSection>
      ...
      {/* TESTIMONIALS */}
      <section className="bg-[#F4E2C0] py-24 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-5 gap-10 md:gap-16 items-start">
            <FadeSection className="md:col-span-3">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-[#1C2B2B] text-sm">James R.</p>
                  <p className="text-xs text-[#0A7075] mt-0.5">Australia · 2025</p>
                </div>
              </div>
            </FadeSection>
      ...
      {/* FAQ */}
      <section id="faq" className="py-24 px-6 bg-[#FAFAF5]">
        <div className="max-w-3xl mx-auto">
          <FadeSection className="text-center mb-14">
            <p className="text-xs uppercase tracking-[0.25em] text-[#0A7075] font-medium mb-3">Common Questions</p>
            <h2 className="font-display text-5xl font-light text-[#1C2B2B]">FAQ</h2>
            <p className="mt-4 text-[#2E4444] text-sm leading-relaxed">Everything you need to know before booking your surf lessons in Bali.</p>
          </FadeSection>
          <div className="space-y-4">
            {faqItems.map((item, i) => (
              <FadeSection key={i} className="bg-white rounded-2xl p-7 shadow-sm border border-[#E0E0D8]" style={{ transitionDelay: `${i * 0.05}s` }}>
                <h3 className="font-display text-lg font-semibold text-[#1C2B2B] mb-3 flex items-start gap-3">
                  <span className="text-[#0A7075] font-display font-light text-2xl leading-none shrink-0 -mt-0.5">Q</span>
                  {item.q}
                </h3>
                <p className="text-sm text-[#2E4444] leading-relaxed pl-9">{item.a}</p>
              </FadeSection>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="py-24 md:py-36 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-start">
          <FadeSection>
            ...
            <h2 className="font-display text-5xl md:text-6xl font-light leading-tight mb-6">Ready to Surf?</h2>
            <div className="w-12 h-0.5 bg-[#0A7075] mb-8" />
            <p className="text-[#2E4444] leading-relaxed mb-6">Drop me a message on WhatsApp or fill out the form and I&apos;ll get back to you within a few hours. Let&apos;s find the perfect session for you.</p>
            <a href="https://maps.app.goo.gl/L2vwUwsubBKG5FWZA" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 mb-8 p-4 bg-[#F4E2C0]/60 rounded-xl border border-[#D4B896]/40 hover:bg-[#F4E2C0]/90 transition-colors group">
              <svg className="w-4 h-4 text-[#0A7075] shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><circle cx="12" cy="9" r="2.5"/></svg>
            ...
            <div className="space-y-5">
              <a href="https://wa.me/6281353282623?text=Hi%20Taufik!%20I'd%20love%20to%20book%20a%20surf%20lesson." target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 bg-[#25D366]/10 border border-[#25D366]/30 rounded-xl hover:bg-[#25D366]/20 transition-colors group">
                ...
                <div><p className="font-medium text-[#1C2B2B] text-sm">WhatsApp</p><p className="text-xs text-[#2E4444]">Fastest way to reach me</p></div>
                <svg className="ml-auto w-4 h-4 text-[#2E4444] group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
              </a>
              <a href="https://www.instagram.com/surf_with_t" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 bg-[#0A7075]/5 border border-[#0A7075]/20 rounded-xl hover:bg-[#0A7075]/10 transition-colors group">
                ...
                <div><p className="font-medium text-[#1C2B2B] text-sm">@surf_with_t</p><p className="text-xs text-[#2E4444]">See more sessions &amp; vibes</p></div>
                <svg className="ml-auto w-4 h-4 text-[#2E4444] group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
              </a>
              <a href="mailto:surfwitht@gmail.com" className="flex items-center gap-4 p-4 bg-[#0A7075]/5 border border-[#0A7075]/20 rounded-xl hover:bg-[#0A7075]/10 transition-colors group">
                <div className="w-10 h-10 bg-[#0A7075] rounded-full flex items-center justify-center shrink-0">
                  <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" stroke="white" strokeWidth="1.8"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><path d="M22 6l-10 7L2 6" /></svg>
                </div>
                <div><p className="font-medium text-[#1C2B2B] text-sm">surfwitht@gmail.com</p><p className="text-xs text-[#2E4444]">Drop us a message anytime</p></div>
                <svg className="ml-auto w-4 h-4 text-[#2E4444] group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
              </a>
            </div>
            <div className="mt-8 rounded-2xl overflow-hidden border border-[#E0E0D8] shadow-sm">
              <iframe src="https://maps.google.com/maps?q=Jl.+Pantai+Balangan+315,+Jimbaran,+Bali+80361&output=embed" width="100%" height="240" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Surf With Tee location on Google Maps" />
              <a href="https://maps.app.goo.gl/L2vwUwsubBKG5FWZA" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 py-3 bg-[#0A7075] text-white text-xs font-medium tracking-wide hover:bg-[#065052] transition-colors">
          ...
          <FadeSection>
            <ContactFormWrapper />
            <div className="mt-4">
              <div className="px-1 py-4 border-t border-[#E0E0D8]">
      ...
      <footer className="bg-[#1C2B2B] text-white py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-[#9BBEBE]/60">© {new Date().getFullYear()} Surf With Tee. All rights reserved.</p>
        </div>
        <div className="max-w-7xl mx-auto mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-[#9BBEBE]/40">
            Made with ❤️ in Bali ·{" "}
            <a href="https://9line.dev" target="_blank" rel="noopener noreferrer" className="hover:text-[#9BBEBE]/70 transition-colors underline underline-offset-2">9line.dev</a>
          </p>
          <a href="/privacy" className="text-xs text-[#9BBEBE]/40 hover:text-[#9BBEBE]/70 transition-colors underline underline-offset-2">Privacy Policy</a>
        </div>
      </footer>
    </main>
  );
